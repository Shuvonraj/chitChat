      ...
      <section className='flex lg:justify-between lg:mx-0 mx-auto w-screen text-center lg:text-left overflow-x-hidden '>
        <div className='lg:w-2/4 w-[8977px] lg:ml-[193px] mt-[99px] lg:mt-[225px]  font-nunito '>
          ...
          <div className='mt-[62px] relative'>
            <input onChange={handleEmail} placeholder='Email' className='border-2 focus:outline-none   lg:w-96 py-6 px-14 border-[#11175D]  border-opacity-25 rounded-lg' type="text " />
          ...
          <div  className='mt-[56px] relative'>
            <input onChange={handlefullName} placeholder='Your Name' className='border-2 focus:outline-none   lg:w-96 py-6 px-14 border-[#11175D]  border-opacity-25 rounded-lg' type="text " />
          ...
          <div className='mt-[56px] relative'>
            <input onChange={handlePassword} placeholder='******' className='border-2 focus:outline-none  lg:w-96 py-6 px-14 border-[#11175D]  border-opacity-25 rounded-lg' type="password" />
          ...
          <button onClick={handleSubmit} className='lg:px-[158px] px-[124px]  lg:w-96 font-nunito font-semibold text-white hover:bg-[#5f35f5a9] bg-[#5F35F5] py-5 mt-[52px] rounded-[86px] '>Sign up</button>
